...
extension View {
    ...
    //MARK: Extracting View's Height and with the help of hosting Controller and ScrollView
    ...
    func exportPDF<Content: View>(@ViewBuilder content: @escaping ()->Content, completion: @escaping (Bool, URL?)->()) {
        ...
        let outputFileURL = documentDirectory.appendingPathComponent("ProtocolPDF\(UUID().uuidString).pdf")
